...
<div class="py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        @endif
            ...
            <!-- Transactions Tab -->
            <div x-show="activeTab === 'transactions'" x-cloak class="px-6 py-5">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <button onclick="if(confirm('Withdraw all available balance?')) document.getElementById('withdrawal-form').submit();" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition">
                        <svg class="-ml-1 mr-2 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                        Withdraw Balance
                    </button>
                    <form id="withdrawal-form" action="{{ route('routers.withdraw', $router) }}" method="POST" class="hidden">
                        @csrf
                    </form>
                </div>
