    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        @endif
            ...
            <div x-show="activeTab === 'vouchers'" x-cloak class="px-6 py-5">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <div class="flex space-x-2">
                        <form action="{{ route('routers.loadVouchers', $router) }}" method="POST" class="inline">
                            @csrf
                            <button type="submit" class="inline-flex items-center px-4 py-2 border  shadow-sm text-sm font-medium rounded-md  bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition">
                                <svg class="-ml-1 mr-2 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/>
                                </svg>
                                Load Vouchers from Router
                            </button>
                        </form>
            ...
            <div x-show="activeTab === 'transactions'" x-cloak class="px-6 py-5" x-data="{ showWithdrawModal: false, withdrawAmount: {{ $router->wallet_balance }}, phoneNumber: '{{ auth()->user()->phone_number ?? '' }}' }">
                ...
                <!-- Withdrawal Modal -->
                <div x-show="showWithdrawModal" class="fixed inset-0 z-50 overflow-y-auto" style="display: none;" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                    <!-- Background overlay -->
                    ...
                    <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                        ...
                        <div x-show="showWithdrawModal"
                             ...
                             class="relative inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6 z-50"
                             @click.stop>
                            <div>
