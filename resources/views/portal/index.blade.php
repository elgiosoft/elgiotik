...
<body class="h-full bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
    ...
    <div class="min-h-full py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-6xl mx-auto space-y-8">
            ...
            <!-- Login Card -->
            <div class="max-w-md mx-auto bg-white rounded-2xl shadow-2xl p-8 space-y-6 border border-gray-100">
                <div class="text-center">
                ...
                <div class="text-center pt-4 border-t border-gray-200">
                    ...
                    <a href="#plans" class="font-medium text-blue-600 hover:text-blue-500 transition duration-150">
                        Purchase a plan →
                    </a>
                </div>
            </div>
            ...
            <!-- Plans Section -->
            <div id="plans" class="pt-8">
                <div class="text-center mb-12">
                    <h2 class="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 mb-3">
                        Choose Your Plan
                    </h2>
                    <p class="text-lg text-gray-600">Select the perfect internet package for your needs</p>
                </div>
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div class="bg-white rounded-2xl shadow-2xl border @if($isPopular) border-purple-500 @else border-gray-100 @endif p-6 hover:shadow-xl transition-all duration-150 relative">

                        @if($isPopular)
                        <div class="absolute -top-3 left-1/2 -translate-x-1/2 bg-gradient-to-r from-blue-600 to-purple-600 text-white text-xs font-bold px-4 py-1 rounded-full shadow-lg">
                            POPULAR
                        </div>
                        @endif

                        <div class="text-center mb-6 @if($isPopular) mt-2 @endif">
                            <h3 class="text-xl font-bold text-gray-900 mb-4">
                                {{ $plan->name }}
                            </h3>

                            <div class="mb-4">
                                <span class="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">
                        ...
                        <form action="{{ route('portal.payment') }}" method="GET">
                            ...
                            <button
                                type="submit"
                                class="w-full py-3 px-4 border border-transparent text-sm font-semibold rounded-lg @if($isPopular) text-white bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 shadow-lg @else text-gray-700 bg-gray-100 hover:bg-gray-200 @endif focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-150">
                                Select Plan
                            </button>
                        </form>
                    </div>
